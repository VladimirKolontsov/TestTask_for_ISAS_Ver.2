...
create table product_model_attribute (
    id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    product_module_id int NOT NULL REFERENCES product_model (id) ON DELETE CASCADE,
    name varchar(50),
    value varchar(100)
);
...
values ('TV', 'Japan', 'Sony', TRUE, TRUE, true),
       ...
       ('Vacuum cleaner', 'Netherlands', 'Philips', TRUE, TRUE, true),
       ('Vacuum cleaner', 'Korea', 'Samsung', FALSE, TRUE, TRUE),
       ('Vacuum cleaner', 'Switzerland', 'Polaris', TRUE, FALSE, TRUE),
...
insert into product_model_attribute (product_module_id, name, value)
values (1, 'category', 'auto'),
       ...
       (13, 'type of compressor', 'inventor'),
       (14, 'quantity of doors', '1'),
       (14, 'type of compressor', 'inventor'),
       (15, 'quantity of doors', '1'),
       (15, 'type of compressor', 'line'),
       (16, 'quantity of doors', '2'),
       (16, 'type of compressor', 'inventor'),
       (17, 'quantity of doors', '2'),
       (17, 'type of compressor', 'line'),
       (18, 'quantity of doors', '1'),
       (18, 'type of compressor', 'line'),
       (19, 'phone memory', '64'),
       ...
       (25, 'category', 'laptop'),
       (25, 'type of processor', 'intel core i5'),
       (26, 'category', 'laptop'),
       (26, 'type of processor', 'intel core i3'),
       (27, 'category', 'laptop'),
       (27, 'type of processor', 'intel core i7'),
       (28, 'category', 'laptop'),
       (28, 'type of processor', 'AMD Ryzen'),
       (29, 'category', 'laptop'),
       (29, 'type of processor', 'intel core i5'),
       (30, 'category', 'laptop'),
       (30, 'type of processor', 'apple m2');
